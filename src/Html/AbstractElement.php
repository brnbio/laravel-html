...
use Brnbio\LaravelHtml\Template\StringTemplate;
...
abstract class AbstractElement
{
    ...
    public const ATTRIBUTE_HREFLANG = 'hreflang';
    ...
    public const ATTRIBUTE_REL = 'rel';
    ...
    public const ATTRIBUTE_EVENTS_CLICK = 'onclick';
    ...
    public const ATTRIBUTE_ROLE_LINK = 'link';
    public const ATTRIBUTE_ROLE_BUTTON = 'button';
    public const ATTRIBUTE_ROLE_CHECKBOX = 'link';
    public const ATTRIBUTE_ROLE_RADIO = 'radio';
    public const ATTRIBUTE_ROLE_SWITCH = 'switch';
    public const ATTRIBUTE_ROLE_TAB = 'tab';
    public const ATTRIBUTE_ROLE_TREEITEM = 'treeitem';
    ...
    {
        return (string)config('laravel-html.templates.' . static::class) ?: $this->defaultTemplate;
    }
